        ...
        <div className="flex flex-wrap items-center gap-3 mb-6">
          <div className="relative flex-1 max-w-xs">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 text-sm bg-surface border border-border rounded-xl text-text placeholder:text-text-dim focus:outline-none focus:border-primary/50 transition-transform"
            />
            {search && (
              <button
                onClick={() => setSearch("")}
          ...
          <button
            ...
            className={`px-3 py-1.5 text-xs font-medium rounded-lg border transition-transform ${activeType === "all" ? "bg-primary/15 border-primary/40 text-primary" : "border-border text-text-muted hover:text-text"}`}
          >
            ...
            .map(([type]) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg border transition-transform ${activeType === type ? "bg-primary/15 border-primary/40 text-primary" : "border-border text-text-muted hover:text-text"}`}
                >
