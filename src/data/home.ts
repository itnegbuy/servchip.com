...
export const STATS: Stat[] = [
  ...
  { value: 27, suffix: "", label: "Manufacturer Partnerships", icon: "Handshake" },
...
export const SERVICES: ServiceItem[] = [
  {
    ...
    features: ["End-of-life procurement", "Hard-to-find components", "Cross-reference matching", "Global supplier network"],
  },
  {
    icon: Headphones,
    title: "Technical Support",
    desc: "Multi-vendor engineering support for integration, tuning, and deployment of enterprise chips.",
    features: ["24/7 engineering access", "Multi-vendor expertise", "Remote diagnostics", "Performance tuning"],
  },
  {
    icon: Cpu,
    title: "System Integration",
    desc: "Pre-configured rack-level integration with full testing and validation before shipping.",
    features: ["Rack integration services", "Pre-shipment testing", "Custom configurations", "Quality validation"],
  },
  {
    icon: ClipboardCheck,
    title: "Engineering Consulting",
    desc: "Architecture review and workload optimization across all major chip platforms.",
    features: ["Architecture planning", "Workload benchmarking", "Migration strategy", "ROI analysis"],
  },
  {
    icon: ShieldCheck,
    title: "Warranty & RMA",
    desc: "Comprehensive warranty coverage with advanced replacement and depot repair services.",
    features: ["3-year base warranty", "Advanced replacement", "Extended coverage", "Global RMA support"],
  },
];
    ...
    items: [
      {
        ...
        answer: "Yes. Every chip is sourced directly from manufacturers or authorized distributors. We maintain full chain of custody documentation and each shipment includes a certificate of authenticity. Zero counterfeit policy is enforced across all 27+ manufacturer partnerships.",
      },
      {
        question: "Can you help me choose the right chip?",
        answer: "Absolutely. Our engineering team provides free technical consultation to help match the right chip to your workload. We offer architecture reviews, workload benchmarking, and side-by-side comparisons across all brands.",
      },
      {
        question: "What brands do you carry?",
        answer: "We carry products from 27+ manufacturers including NVIDIA, AMD, Intel, Broadcom, Marvell, Cisco, Qualcomm, Samsung, SK hynix, Micron, Seagate, Dell, HPE, Supermicro, Lenovo, and more. Our catalog covers AI accelerators, server CPUs, AI servers, networking, and memory & storage.",
      },
      {
        question: "Do you sell both new and refurbished?",
        answer: "We specialize in new, factory-sealed enterprise hardware sourced directly from manufacturers and authorized distributors. All products come with full manufacturer warranty and chain of custody documentation.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: "There is no minimum order quantity. Whether you need a single chip for testing or thousands for a full data center deployment, we can fulfill your order. Volume discounts apply for bulk orders.",
      },
      {
        question: "What payment terms are available?",
        answer: "We accept wire transfers, credit cards, and Net-30/Net-60 terms for qualified enterprise customers. Volume-based pricing is available for bulk and recurring orders. Contact our sales team for custom quotes.",
      },
      {
        question: "How do I request a quote?",
        answer: "Use our online RFQ form or contact our sales team directly. We respond to all quote requests within 24 hours. For urgent needs, our live chat and phone support provide instant assistance.",
      },
      {
        question: "Do you offer volume discounts?",
        answer: "Yes, we offer tiered pricing for bulk orders. Discounts scale with order volume and frequency. Contact our sales team with your requirements for a customized quote with volume pricing.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: "Standard delivery is 3-5 business days for in-stock items. Express shipping is available for urgent needs. We ship to 150+ countries with secure, insured logistics and real-time tracking.",
      },
      {
        question: "Do you support international shipping?",
        answer: "Yes, we ship to over 150 countries worldwide. We handle all customs documentation, duties, and taxes where applicable. Each shipment is fully insured with end-to-end tracking.",
      },
      {
        question: "How are orders shipped and packaged?",
        answer: "All chips are packaged in anti-static ESD-safe packaging with proper cushioning for transit. Enterprise orders are shipped on pallets with shock sensors. Each package includes full documentation and certificate of authenticity.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: "All products come with a minimum 3-year manufacturer warranty. We also offer extended warranty plans and advanced replacement services. Our RMA team handles the entire process for hassle-free support.",
      },
      {
        question: "What kind of technical support do you offer?",
        answer: "Our engineering team provides 24/7 technical support across all brands. Services include architecture consultation, performance tuning, remote diagnostics, and deployment assistance for AI, HPC, and data center workloads.",
      },
      {
        question: "How does the RMA process work?",
        answer: "Our RMA team handles everything from diagnosis to replacement. We provide prepaid return labels, cross-ship advanced replacements when needed, and track every case to resolution. Typical RMA turnaround is 5-7 business days.",
      },
    ],
  },
];
