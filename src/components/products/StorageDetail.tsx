            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-text-muted">
                  Complete technical specifications for the {st.series}.
                </p>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  rows: [
                    ...
                    { label: "Interface", key: "interface" as const },
                  ],
                },
                {
                  title: "Capacity",
                ...
                },
                {
                  ...
                  icon: Gauge,
                  rows: [
                    { label: "Read Speed", key: "readSpeed" as const },
                    { label: "Write Speed", key: "writeSpeed" as const },
                  ],
                },
                {
                  title: "Reliability",
                  ...
                  rows: [
                    ...
                    { label: "Endurance", key: "endurance" as const },
                  ],
                },
              ].map((group) => (
                <div
